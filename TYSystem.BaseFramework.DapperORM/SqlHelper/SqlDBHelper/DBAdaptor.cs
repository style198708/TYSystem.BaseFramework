...
namespace TYSystem.BaseFramework.Dapper.SqlDBHelper
{
    ...
    public class DBAdaptor : IDBHelper
    {
        ...
        {
            using (SqlConnection conn = GetConnByKey(connKey))
            {
        ...
        {
            return SQLHelper.ExecuteDataset((SqlConnection)conn, commandText, commandParameters, commandType, commandTimeout);
        }
        ...
        {
            return SQLHelper.ExecuteNonQuery((SqlConnection)conn, commandText, commandParameters, commandType, commandTimeout);
        }
        ...
        {
            SqlConnection conn = GetConnByKey(connKey);
        ...
        {
            return SQLHelper.ExecuteReader((SqlConnection)conn, commandText, commandParameters, commandType, commandTimeout);
        }
        ...
        {
            IDataReader dr = SQLHelper.ExecuteReader((SqlConnection)conn, commandText, commandParameters, commandType, commandTimeout);
            return DataReaderExtensions.DataReaderToList<T>(dr);
        }
        ...
        {
            return SQLHelper.ExecuteScalar((SqlConnection)conn, commandText, commandParameters, commandType, commandTimeout);
        }
