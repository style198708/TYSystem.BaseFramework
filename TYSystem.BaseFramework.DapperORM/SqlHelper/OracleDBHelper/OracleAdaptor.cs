...
namespace TYSystem.BaseFramework.Dapper.OracleDBHelper
{
    ...
    public class OracleAdaptor : IDBHelper
    {
        ...
        public OracleAdaptor(string connectionStringKey = "")
        {
        ...
        {
            using (OracleConnection conn = GetConnByKey(connKey))
            {
        ...
        {
            return SQLHelper.ExecuteDataset((OracleConnection)conn, commandText, commandParameters, commandType, commandTimeout);
        }
        ...
        {
            return SQLHelper.ExecuteNonQuery((OracleConnection)conn, commandText, commandParameters, commandType, commandTimeout);
        }
        ...
        {
            OracleConnection conn = GetConnByKey(connKey);
        ...
        {
            return SQLHelper.ExecuteReader((OracleConnection)conn, commandText, commandParameters, commandType, commandTimeout);
        }
        ...
        {
            IDataReader dr = SQLHelper.ExecuteReader((OracleConnection)conn, commandText, commandParameters, commandType, commandTimeout);
            return DataReaderExtensions.DataReaderToList<T>(dr);
        }
        ...
        {
            return SQLHelper.ExecuteScalar((OracleConnection)conn, commandText, commandParameters, commandType, commandTimeout);
        }
