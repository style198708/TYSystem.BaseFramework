...
namespace TYSystem.BaseFramework.Common.Redis
{
    public class RedisConfig
    {
        ...
        private static string RedisPwd = "value";
        ...
        //    string filePath = Path.Combine(System.Configuration.ConfigurationManager.AppSettings["ConfigPath"], "Redis.config");
        //    if (File.Exists(filePath))
        //    {
        //        config = (RedisEntityConfig)SerializerXml.LoadSettings(filePath, typeof(RedisEntityConfig));
        //    }
        //    else
        //    {
        //        filePath = FileHandler.GetConfigPath + "\\Redis.config";
        //        if (File.Exists(filePath))
        //        {
        //            config = (RedisEntityConfig)SerializerXml.LoadSettings(filePath, typeof(RedisEntityConfig));
        //        }
        //        else
        //        {
        //            throw new Exceptions.WaLiuException("没有找到Redis.config的配置文件，请确保：" + filePath + "文件存在");
        //        }
        //    }
        //    //Log.Logger.Info(string.Format("初始化{0}完成。", filePath));
        //    return config;
        //}
