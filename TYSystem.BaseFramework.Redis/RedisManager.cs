...
namespace TYSystem.BaseFramework.Common.Redis
{
    /// <summary>
    /// 缓存管理
    /// 1.要可以查看所有的缓存
    ...
    public class RedisManager
    {
        ...
        /// <param name="expiry"></param>
        /// <returns></returns>
        public async Task<bool> StringSetAsync<T>(string key, T obj, TimeSpan? expiry = default(TimeSpan?)) where T : class
        {
            key = AddSysCustomKey(key);
            string json = ConvertJson(obj);
        ...
        /// <param name="t"></param>
        /// <returns></returns>
        public bool HashSet<T>(string key, string dataKey, T t) where T : class
        {
            key = AddSysCustomKey(key);
            return Do(db =>
            {
        ...
        /// <param name="t"></param>
        /// <returns></returns>
        public async Task<bool> HashSetAsync<T>(string key, string dataKey, T t) where T : class
        {
            key = AddSysCustomKey(key);
            return await Do(db =>
            {
        ...
        public void ListRemove<T>(string key, T value) where T : class
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public void ListRightPush<T>(string key, T value) where T : class
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public void ListLeftPush<T>(string key, T value) where T : class
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public async Task<long> ListRemoveAsync<T>(string key, T value) where T : class
        {
            key = AddSysCustomKey(key);
        ...
        public bool SortedSetAdd<T>(string key, T value, double score) where T : class
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public bool SortedSetRemove<T>(string key, T value) where T : class
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="value"></param>
        /// <param name="score"></param>
        public async Task<bool> SortedSetAddAsync<T>(string key, T value, double score) where T : class
        {
            key = AddSysCustomKey(key);
        ...
        /// <param name="key"></param>
        /// <param name="value"></param>
        public async Task<bool> SortedSetRemoveAsync<T>(string key, T value) where T : class
        {
            key = AddSysCustomKey(key);
        ...
        private string ConvertJson<T>(T value) where T : class
        {
            string result = SerializerJson.JsonSerializeObject<T>(value);
            return result;
        }
